...
arr_result = np.matmul(arr1, vector.reshape(-1, 1))

print(f"Matrix-vector product of arr1 and vector is: \n{arr_result}")

arr_result = np.matmul(arr1, vector.reshape(-1, 1))

print(f"Matrix-vector product of arr1 and vector (using reshape) is: \n{arr_result}")
